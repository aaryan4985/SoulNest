...
function Signup() {
    ...
    const handleSignup = async (e) => {
        ...
        try {
            ...
            const userCredential = await createUserWithEmailAndPassword(auth, signupInfo.username, signupInfo.password);
            ...
            // Navigate to tracker page after successful signup (consistent with login)
            navigate("/tracker");
        } catch (error) {
    ...
    const handleGoogleSignup = async () => {
        ...
        try {
            ...
            // Navigate to tracker page after successful Google signup
            navigate("/tracker");
        } catch (error) {

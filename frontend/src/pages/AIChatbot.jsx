        ...
        <div className="max-w-4xl mx-auto space-y-4">{messages.map((message) => (
          ...
          >
            ...
            >
              ...
              <div
                className={`p-3 rounded-2xl shadow-sm ${message.sender === "user"
              ...
              >
                ...
                {/* Message Info */}
                <div className={`flex items-center justify-between mt-2 text-sm ${message.sender === "user" ? "text-white/70" : "text-gray-500"
                  }`}>
                  <span>
